...
const Trainingcatagery = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-200 flex items-center justify-center p-4 text-black">
      <div className="w-full max-w-md mt-4 bg-white rounded shadow-md">
        <h1 className='text-red-700 text-lg text-center'>Training Course Categories</h1>
...
export default Trainingcatagery;

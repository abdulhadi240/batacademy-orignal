...
const Diplomacatagery = () => {
  const categories = [
    {
      name: "Management",
      subcategories: [
        {  name: "Mini Diploma in Swift Banking Transfer", link: 
          "/Mini-Diploma-in-Swift-Banking-Transfer" },
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-200 flex items-center justify-center p-4 text-black">
      ...
      <div className="w-full max-w-md bg-white rounded-lg shadow-md">
        <h1 className=' text-red-700 text-lg text-center'>Deploma Categories</h1>
...
export default Diplomacatagery;

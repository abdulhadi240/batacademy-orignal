...
export default function Certificate({ locale }) {
  ...
  // Arabic translations for static texts
  const certificationText = isArabic ? "شهادة مهنية" : "Professional Certification";
  const headingText = isArabic ? "احصل على شهادة مهنية" : "Earn a career certificate";
  const stepOneText = isArabic
    ? "أضف هذه الشهادة إلى ملفك على لينكدإن، سيرتك الذاتية أو الـ CV"
    : "Add this credential to your LinkedIn profile, resume, or CV";
  const stepTwoText = isArabic
    ? "شاركها على وسائل التواصل الاجتماعي وفي تقييم أدائك"
    : "Share it on social media and in your performance review";

  return (
    <div className="px-4" dir={isArabic ? "rtl" : "ltr"}>
                ...
                <div className="relative bg-white p-6 rounded-xl">
                  <div className="w-full lg:w-72 space-y-6">
                    <div className="flex justify-between items-start">
                      ...
                      <Award className={cn("h-8 w-8", primaryColor.foreground)} />
                    </div>
